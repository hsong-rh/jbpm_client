...
module JBPMAPIClient
  ...
  class VariableInstance
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'old-value')
        self.old_value = attributes[:'old-value']
      end
      ...
      if attributes.has_key?(:'modification-date')
        self.modification_date = attributes[:'modification-date']
      end
    ...
    def hash
      [name, old_value, value, process_instance_id, modification_date].hash
    end
