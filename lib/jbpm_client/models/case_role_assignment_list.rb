...
module JBPMAPIClient
  ...
  class CaseRoleAssignmentList
    ...
    def self.swagger_types
      {
        :'role_assignments' => :'Array<CaseRoleAssignment>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'role-assignments')
        if (value = attributes[:'role-assignments']).is_a?(Array)
