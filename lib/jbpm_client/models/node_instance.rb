...
module JBPMAPIClient
  ...
  class NodeInstance
    ...
    attr_accessor :node_connection

    attr_accessor :node_completed
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'node-name')
        self.node_name = attributes[:'node-name']
      end
      ...
      if attributes.has_key?(:'node-type')
        self.node_type = attributes[:'node-type']
      end

      if attributes.has_key?(:'node-connection')
        self.node_connection = attributes[:'node-connection']
      end

      if attributes.has_key?(:'node-completed')
        self.node_completed = attributes[:'node-completed']
      end

      if attributes.has_key?(:'reference-id')
        self.reference_id = attributes[:'reference-id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          node_connection == o.node_connection &&
          node_completed == o.node_completed &&
    ...
    def hash
      [node_instance_id, node_name, process_instance_id, work_item_id, container_id, start_date, node_id, node_type, node_connection, node_completed, reference_id, sla_compliance, sla_due_date].hash
    end
